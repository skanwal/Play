...
```{r fusions_figs, comment = NA, message=TRUE, warning=FALSE}
#knitr::opt_chunk$set(base.dir="~/Documents/UMCCR/data/fusions/", base.url="/")
#knitr::opt_chunk$set(fig.path = "pizzly-validation/", base.url="/")

fusion_graph <- paste(params$pizzly_folder, paste0(pizzly.fusions2$geneA.name[1], "_", pizzly.fusions2$geneB.name[1], ".pdf"), sep = "/")
#fusion_graph <- params$pizzly_folder

include_graphics(fusion_graph)
